...
<div class="pre-collection">
    ...
    <div class="link-grid-container">
        <a href="{{route('collection')}}/?collection=linass" class="link-wrap"
           style="background-image: url({{ secure_asset('/images/Linass/Accessories_Linass_white_2.png') }})">
            <h3 class="">LINASS</h3>
        </a>
        <a href="{{route('collection')}}/?collection=rodions" class="link-wrap"
           style="background-image: url({{ secure_asset('/images/Rodions/Accessories_Rodions_purple_1.png') }})">
            <h3 class="">RODIONS</h3>
        </a>
        <a href="{{route('collection')}}/?collection=katerina" class="link-wrap"
        style="background-image: url({{ secure_asset('/images/Katerina/Hoodie_Katerina_white_2.png') }})">
         <h3 class="">KATERINA</h3>
     </a>
        <a href="{{route('collection')}}/?collection=deniss" class="link-wrap"
        style="background-image: url({{ secure_asset('/images/Deniss/Shoes_Deniss_white_1.png') }})">
         <h3 class="">DENISS</h3>
     </a>
        <a href="{{route('collection')}}/?collection=Aleks" class="link-wrap"
           style="background-image: url({{ secure_asset('/images/Aleks/Accessories_Aleks_white_1.png') }})">
            <h3 class="">Aleks</h3>
        </a>
        <a href="{{route('sales')}}" class="link-wrap"
           style="background-image: url({{ secure_asset('/images/Katerina/Hat_Katerina_black_3.png') }})">
