...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('css/shipping.css') }}">
...
<div class="text-block">
    ...
    <div class="shipping-options">
        <div class="shipping-options-item"><div class="shipping-logo"><img src="{{ secure_asset("svg/Omniva.svg") }}" width="60" alt="Omniva" class="logo"></div>
        <p class="caption-text">Omniva</p></div>
        <div class="shipping-options-item"><div class="shipping-logo"><img src="{{ secure_asset("svg/DPD.svg") }}" width="42" alt="DPD" class="logo"></div>
        <p class="caption-text">DPD</p></div> 
        <div class="shipping-options-item"><div class="shipping-logo"><img src="{{ secure_asset("svg/LatvijasPasts.svg") }}" width="60" alt="Latvijas Pasts" class="logo"></div>
