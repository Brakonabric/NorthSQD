...
<div class="sticky-bar">
    <div class="navbar-header">
        ...
        <a class="logo-container" href="{{ route('home') }}"><img src="{{ secure_asset('svg/logo.svg') }}"
                alt="#" class="logo"></a>
            ...
            <div class="search-pc">
                ...
                <form action="{{ route('searchRed') }}" method="get" class="search-form">
                    <div class="search-container">
                        ...
                        <input type="search" id="search-bar-input-pc" name="search" placeholder="Search..."
                            autocomplete="off">
                    </div>
...
<div class="search-bar-mobile" id="search-bar-mobile">
    ...
    <form action="{{ route('searchRed') }}" method="get" class="search-form">
        <div class="close-title">
            ...
            <button class="close-button" id="close-button" type="button">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
