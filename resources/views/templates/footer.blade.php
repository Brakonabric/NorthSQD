...
<div class="footer-module">
    <div class="mobile-contacts mobile">
                ...
                <ul>
                    <li>
                        <a href="https://www.google.com/maps?q=Magebit+Riga">
                            <img class="footer-svg" src="{{secure_asset('svg/Icon-Address.svg')}}" alt="Company Address">2a Uriekstes,
                                Riga</a>
                    </li>
                    <li>
                        <a href="tel:+371 25000666"><img class="footer-svg" src="{{secure_asset("svg/Icon_Phone.svg")}}" alt="Contact Phone Number">+371
                                25000666
                        </a>
                    </li>
                    <li>
                        <a href="mailto:info@northsquad.lv"><img class="footer-svg" src="{{secure_asset("svg/Icon_Mail.svg")}}" alt="Contact e-mail">info@northsquad.lv</a>
                    </li>
                    <li class="social-svg">
                        <a href="#"><img src="{{secure_asset('svg/Icon_Twitter.svg')}}" alt="Twitter"></a>
                        <a href="#"><img src="{{secure_asset('svg/Icon_WhatsApp.svg')}}" alt="WhatsApp"></a>
                        <a href="#"><img src="{{secure_asset('svg/Icon_Instagram.svg')}}" alt="Instagram"></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="payment-row">
            <ul>
                <li><img src="{{secure_asset('svg/master card.svg')}}" width="54" alt="MasterCard"></li>
                <li><img src="{{secure_asset('svg/visa.svg')}}"  width="69" alt="Visa"></li>
                <li><img src="{{secure_asset('svg/paypal.svg')}}" width="90" alt="PayPal"></li>
                <li><img src="{{secure_asset('svg/googlePay.svg')}}" width="72" alt="GooglePay"></li>
            </ul>
        </div>
    </div>
        ...
        <div class="row">
            <div class="footer-col pc-contacts pc">
                ...
                <ul>
                    ...
                    <li>
                        <a href="tel:+371 25000666"><img class="footer-svg" src="{{secure_asset('svg/Icon_Phone.svg')}}"
                                                         alt="Contact Phone Number">+371 25000666</a>
                    </li>
                    <li>
                        <a href="mailto:info@northsquad.lv"><img class="footer-svg" src="{{secure_asset('svg/Icon_Mail.svg')}}"
            ...
            <div class="footer-col sales-col">
                ...
                <ul>
                    <li><a href="{{route('sales')}}"><img src="{{ secure_asset('svg/sale-mark.svg') }}" id="sale" alt="Discounts"><strong>SALE</strong></a></li>
                </ul>
            </div>
        </div>
